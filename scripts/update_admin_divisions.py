...
Run with: python -m scripts.update_admin_divisions
"""
...
def update_all_hazards():
    ...
    # Get all hazards
    response = supabase.table('hazards').select('id, location_name, admin_division').execute()
    ...
    for hazard in hazards:
        ...
        # Update database
        try:
            update_response = supabase.table('hazards').update({
